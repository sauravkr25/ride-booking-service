...
public class OlaReverseGeocodeResponseMapper {

    private OlaReverseGeocodeResponseMapper() {}

    public static GeocodeDto toGeocodeDto(OlaReverseGeocodeResponse response) {
        ...
        List<PlaceDetails> placeDetailsList = response.getResults().stream()
